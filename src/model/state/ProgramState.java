...
public class ProgramState {
    ...
    public ProgramState(IStack stk, IMap symtbl, IList<Value> ot, FileTable fileTable, Statement prg, IHeap heap, ILockTable lockTable, int ignoredId) {
        this.exeStack = stk;
    ...
    public ProgramState(IStack stk, IMap symtbl, IList<Value> ot, FileTable fileTable, IHeap heap, ILockTable lockTable) {
        this(stk, symtbl, ot, fileTable, null, heap, lockTable, 0);
    }
